...
// Type: ScrollBars.SetMultipleWindEnabledForm
...
{
  public class SetMultipleWindEnabledForm : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineWindCheckBox);
      this.valueFrame.Controls.Add((Control) this.scanlineWindLabel);
      ...
      this.Name = nameof (SetMultipleWindEnabledForm);
      this.Text = "Set Multiple Wind Enabled Values";
      this.FormClosing += new FormClosingEventHandler(this.SetMultipleWindEnabledForm_FormClosing);
    ...
    public SetMultipleWindEnabledForm(
      int fromScanline,
      int toScanline,
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.windEnabled = fromScanline != -1 && scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].WindEnabled;
      this.scanlineWindCheckBox.Checked = this.windEnabled;
    }

    private void SetMultipleWindEnabledForm_FormClosing(object sender, FormClosingEventArgs e) => this.Owner.Enabled = true;
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].WindEnabled = this.windEnabled;
    ...
    private void scanlineWindCheckBox_CheckedChanged(object sender, EventArgs e) => this.windEnabled = ((CheckBox) sender).Checked;
  }
}
