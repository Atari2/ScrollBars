...
// Type: ScrollBars.SetMultipleGroupsForm
...
{
  public class SetMultipleGroupsForm : Form
  {
      ...
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.group = fromScanline != -1 ? scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].Group : 0;
      this.scanlineGroupComboBox.SelectedIndex = this.group;
    }
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].Group = this.group;
    ...
    private void scanlineGroupComboBox_SelectedIndexChanged(object sender, EventArgs e) => this.group = ((ListControl) sender).SelectedIndex;
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineGroupLabel);
      this.valueFrame.Controls.Add((Control) this.scanlineGroupComboBox);
      ...
      this.scanlineGroupLabel.TabIndex = 2;
      ...
      this.Name = nameof (SetMultipleGroupsForm);
      this.Text = "Set Multiple Groups";
