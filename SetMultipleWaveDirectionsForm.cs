...
// Type: ScrollBars.SetMultipleWaveDirectionsForm
...
{
  public class SetMultipleWaveDirectionsForm : Form
  {
    ...
    public SetMultipleWaveDirectionsForm(
      int fromScanline,
      int toScanline,
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.waveDir = fromScanline != -1 ? scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].WaveDirection : 0;
      this.scanlineWaveDirectionComboBox.SelectedIndex = this.waveDir;
    }
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].WaveDirection = this.waveDir;
    ...
    private void scanlineWaveDirectionComboBox_SelectedIndexChanged(object sender, EventArgs e) => this.waveDir = ((ListControl) sender).SelectedIndex;
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineWaveDirectionComboBox);
      ...
      this.scanlineWaveDirectionComboBox.Location = new Point(96, 19);
      ...
      this.scanlineWaveDirectionComboBox.TabIndex = 15;
      ...
      this.Name = nameof (SetMultipleWaveDirectionsForm);
      this.Text = "Set Multiple Wave Directions";
