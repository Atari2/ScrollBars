...
// Type: ScrollBars.SetMultipleWaveSpeedsForm
...
{
  public class SetMultipleWaveSpeedsForm : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineWaveSpeedComboBox);
      ...
      this.Name = nameof (SetMultipleWaveSpeedsForm);
      this.Text = "Set Multiple Wave Speeds";
    ...
    public SetMultipleWaveSpeedsForm(
      int fromScanline,
      int toScanline,
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.waveSpeed = fromScanline != -1 ? scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].WaveSpeedIndex : 8;
      this.scanlineWaveSpeedComboBox.SelectedIndex = this.waveSpeed;
    }
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].WaveSpeedIndex = this.waveSpeed;
    ...
    private void scanlineWaveSpeedComboBox_SelectedIndexChanged(object sender, EventArgs e) => this.waveSpeed = ((ListControl) sender).SelectedIndex;
  }
}
