...
// Type: ScrollBars.SetMultipleWaveTypesForm
...
{
  public class SetMultipleWaveTypesForm : Form
  {
    ...
    public SetMultipleWaveTypesForm(
      int fromScanline,
      int toScanline,
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.waveType = fromScanline != -1 ? scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].WaveTypeIndex : 0;
      this.scanlineWaveTypeComboBox.SelectedIndex = this.waveType;
    }
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].WaveTypeIndex = this.waveType;
    ...
    private void scanlineWaveTypeComboBox_SelectedIndexChanged(object sender, EventArgs e) => this.waveType = ((ListControl) sender).SelectedIndex;
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineWaveDirectionLabel);
      this.valueFrame.Controls.Add((Control) this.scanlineWaveTypeComboBox);
      ...
      this.scanlineWaveDirectionLabel.Location = new Point(6, 22);
      this.scanlineWaveDirectionLabel.Name = "scanlineWaveDirectionLabel";
      this.scanlineWaveDirectionLabel.Size = new Size(66, 13);
      this.scanlineWaveDirectionLabel.TabIndex = 14;
      this.scanlineWaveDirectionLabel.Text = "Wave Type:";
      ...
      this.Name = nameof (SetMultipleWaveTypesForm);
      this.Text = "Set Multiple Wave Types";
