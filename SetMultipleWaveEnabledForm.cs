...
// Type: ScrollBars.SetMultipleWaveEnabledForm
...
{
  public class SetMultipleWaveEnabledForm : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineWaveCheckBox);
      this.valueFrame.Controls.Add((Control) this.scanlineWaveLabel);
      ...
      this.Name = nameof (SetMultipleWaveEnabledForm);
      this.Text = "Set Multiple Wave Enabled Values";
      this.FormClosing += new FormClosingEventHandler(this.SetMultipleWaveEnabledForm_FormClosing);
    ...
    public SetMultipleWaveEnabledForm(
      int fromScanline,
      int toScanline,
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.waveEnabled = fromScanline != -1 && scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].WaveEnabled;
      this.scanlineWaveCheckBox.Checked = this.waveEnabled;
    }

    private void SetMultipleWaveEnabledForm_FormClosing(object sender, FormClosingEventArgs e) => this.Owner.Enabled = true;
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].WaveEnabled = this.waveEnabled;
    ...
    private void scanlineWaveCheckBox_CheckedChanged(object sender, EventArgs e) => this.waveEnabled = ((CheckBox) sender).Checked;
  }
}
