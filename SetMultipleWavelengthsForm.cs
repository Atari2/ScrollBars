...
// Type: ScrollBars.SetMultipleWavelengthsForm
...
{
  public class SetMultipleWavelengthsForm : Form
  {
    ...
    public SetMultipleWavelengthsForm(
      int fromScanline,
      int toScanline,
      ScrollingEffectLayerElementCollection scrollingEffectLayerElementCollection)
    {
      ...
      this.wavelength = fromScanline != -1 ? scrollingEffectLayerElementCollection.LayerData.Table[this.fromScanline].Wavelength : 0;
      this.scanlineWavelengthTextBox.Text = this.wavelength.ToString("X");
    }
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
      ...
      for (int index = num1; index <= num2; ++index)
        this.scrollingEffectLayerElementCollection.LayerData.Table[index].Wavelength = this.wavelength;
    ...
    {
      TextBox textBox = (TextBox) sender;
      this.wavelength = Numbers.Bound(Numbers.IntParseSafe(textBox.Text, NumberStyles.HexNumber, 0), 0, 512);
      textBox.Text = this.wavelength.ToString("X");
    }
    ...
    private void scanlineWavelengthTextBox_KeyPress(object sender, KeyPressEventArgs e)
    {
      if (e.KeyChar != '\r')
        return;
      this.scanlineWavelengthTextBox_Leave(sender, (EventArgs) e);
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.valueFrame.Controls.Add((Control) this.scanlineWavelengthLabel);
      this.valueFrame.Controls.Add((Control) this.scanlineWavelengthTextBox);
      ...
      this.Name = nameof (SetMultipleWavelengthsForm);
      this.Text = "Set Multiple Wavelengths";
